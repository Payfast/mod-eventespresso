			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('payfast', $active_gateways)) {
						echo '<li id="deactivate_payfast" style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&deactivate_payfast=true\';" class="red_alert pointer"><strong>' . __('Deactivate Payfast IPN?', 'event_espresso') . '</strong></li>';
						event_espresso_display_payfast_settings();
					} else {
						echo '<li id="activate_payfast" style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_payfast=true\';" class="green_alert pointer"><strong>' . __('Activate Payfast IPN?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
			...
			<tr>
				<td valign="top"><ul>
						...
						<li>
							...
							<input type="text" name="image_url" size="35" value="<?php echo $payfast_settings['image_url']; ?>" />
							...
							<?php _e('(used for your business/personal logo on the Payfast page)', 'event_espresso'); ?>
						</li>
					</ul></td>
				<td valign="top"><ul><li>
						...
						<li>
							...
							//echo select_input('no_shipping', $values, $payfast_settings['no_shipping']);
							?>
							</li>
						<li>
							<label for="use_sandbox">
								<?php _e('Use the Debugging Feature and the', 'event_espresso'); ?> <a href="https://developer.payfast.com/devscr?cmd=_home||https://cms.payfast.com/us/cgi-bin/?&amp;cmd=_render-content&amp;content_ID=developer/howto_testing_sandbox||https://cms.payfast.com/us/cgi-bin/?&amp;cmd=_render-content&amp;content_ID=developer/howto_testing_sandbox_get_started" title="Payfast Sandbox Login||Sandbox Tutorial||Getting Started with Payfast Sandbox" target="_blank"><?php _e('Payfast Sandbox', 'event_espresso'); ?></a><a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=payfast_sandbox_info"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>/images/question-frame.png" width="16" height="16" /></a>
							</label>
