...
<?php _e('The merchant id available from the \'Settings\' page within the logged in dashboard on payfast.io');?>
</li>
<li>
<strong><?php _e('Payfast Merchant Key', 'event_espresso'); ?></strong><br />
<?php _e('The merchant key available from the \'Settings\' page within the logged in dashboard on payfast.io');?>
</li>
<strong><?php _e('Payfast Passphrase', 'event_espresso'); ?></strong><br />
<?php _e('ONLY INSERT A VALUE INTO THE SECURE PASSPHRASE IF YOU HAVE SET THIS ON THE
